...
namespace SchoolManagement.Website.Controllers
{
    ...
    public class ExamController : Controller
    {
     ...
     && test.TermID == termId && test.ClassID == classId))
        ...
        public ActionResult PrintAdmitCard(string id, int batchId)
        {
            try
            {
                var school = _context.TblCreateSchool.FirstOrDefault();
        ...
        public JsonResult PrintReportCardData(int studentId, int termId, int batchId, string _Name = "1") //, int classId
        {
            try
            {
                ...
                decimal theroyMaxMark = 1; decimal practicalMaxMark = 1; decimal theroyTotalMark = 0; decimal theroyMinMark = 0; decimal practicalMinMark = 0;
                ...
                decimal Tem1total = 0; decimal OptionalSelectioMaxMark = 0; decimal SelectionMaxMark = 1; decimal SelectionMinMark = 1;
                decimal OptionalPromotionaMaxMark = 0; decimal PromotionalMaxMark = 1; decimal UT1MinMark = 0; decimal UT2MinMark = 1;
                decimal Term1TheoryMinMark = 0; decimal Term1PracticalMinMark = 0; decimal Term2TheoryMinMark = 0;
                decimal Term2PracticalMinMark = 0;
                //Add Pre-1 By Atul Kumar
                Tbl_TestRecords obtainedTheoryMarksPre1 = null; Tbl_TestRecords obtainedPracticalMarksPre1 = null;
                decimal Pre1TheoryMaxMark = 0; decimal Pre1PracticalMaxMark = 0; decimal Pre1TheoryMinMark = 0; decimal Pre1PracticalMinMark = 0;

                Tbl_TestRecords obtainedTheoryMarksPromotion = null; Tbl_TestRecords obtainedPracticalMarksPromotion = null;
                decimal SelectionTheoryMaxMark = 0; decimal SelectionPracticalMaxMark = 0; decimal SelectionTheoryMinMark = 0; decimal SelectionPracticalMinMark = 0;
                ...
                decimal PromotionTheoryMinMark = 0; decimal PromotionPracticalMinMark = 0;

                //Add Pre-2 By Atul Kumar
                Tbl_TestRecords obtainedTheoryMarksPre2 = null; Tbl_TestRecords obtainedPracticalMarksPre2 = null;
                decimal Pre2TheoryMaxMark = 0; decimal Pre2PracticalMaxMark = 0; decimal Pre2TheoryMinMark = 0; decimal Pre2PracticalMinMark = 0;
                ...
                List<SubjectData> allSubjects = new List<SubjectData>();
                foreach (var item in AllSubject)
                {
                        ...
                        if (test.Count > 0)
                        {
                            foreach (var testItem in test)
                            {
                                if (termItem.TermID == 1)//UT1
                                {
                                    ...
                                    UT1MinMark = testItem.MinimumMarks;
                                ...
                                if (_Name == "2")
                                {
                                    if (termItem.TermID == 3)//UT2
                                    {
                                        ...
                                        UT2MinMark = testItem.MinimumMarks;
                                    ...
                                    if (termItem.TermID == 2)//Term1
                                    {
                                        ...
                                        if (testItem.TestType == "Theory")
                                        {
                                            ...
                                            Term1TheoryMinMark = testItem.MinimumMarks;
                                            theroyMinMark = testItem.MinimumMarks;
                                        ...
                                        if (testItem.TestType == "Practical")
                                        {
                                            ...
                                            Term1PracticalMinMark = testItem.MinimumMarks;
                                            practicalMinMark = testItem.MinimumMarks;
                                    ...
                                    if (termItem.TermID == 4)//Term2
                                    {
                                        if (testItem.TestType == "Theory")
                                        {
                                            ...
                                            theroyMaxMark = testItem.MaximumMarks;
                                            Term2TheoryMinMark = testItem.MinimumMarks;
                                            theroyMinMark = testItem.MinimumMarks;
                                        ...
                                        if (testItem.TestType == "Practical")
                                        {
                                            ...
                                            practicalMaxMark = testItem.MaximumMarks;
                                            Term2PracticalMinMark = testItem.MinimumMarks;
                                            practicalMaxMark = testItem.MinimumMarks;
                                ...
                                if (termItem.TermID == 6)//Preboard
                                {
                                    if (testItem.TestType == "Theory")
                                    {
                                        ...
                                        theroyMaxMark = testItem.MaximumMarks;
                                        PromotionTheoryMinMark = testItem.MinimumMarks;
                                        theroyMinMark = testItem.MinimumMarks;
                                    ...
                                    if (testItem.TestType == "Practical")
                                    {
                                        ...
                                        practicalMaxMark = testItem.MaximumMarks;
                                        PromotionPracticalMinMark = testItem.MinimumMarks;
                                        practicalMinMark = testItem.MinimumMarks;
                                ...
                                if (termItem.TermID == 5)//Preboard
                                {
                                    if (testItem.TestType == "Theory")
                                    {
                                        ...
                                        SelectionTheoryMinMark = testItem.MinimumMarks;
                                    ...
                                    if (testItem.TestType == "Practical")
                                    {
                                        ...
                                        SelectionPracticalMaxMark = testItem.MaximumMarks;
                                        SelectionPracticalMinMark = testItem.MinimumMarks;
                                ...
                                if (termId != 10)
                                {
                                    if (termItem.TermID == 7)//PreBoard1
                                    {
                                        if (testItem.TestType == "Theory")
                                        {
                                            ...
                                            theroyMaxMark = testItem.MaximumMarks;
                                            Pre1TheoryMinMark = testItem.MinimumMarks;
                                            theroyMinMark = testItem.MinimumMarks;
                                        ...
                                        if (testItem.TestType == "Practical")
                                        {
                                            ...
                                            practicalMaxMark = testItem.MaximumMarks;
                                            Pre1PracticalMinMark = testItem.MinimumMarks;
                                            practicalMinMark = testItem.MinimumMarks;
                                    ...
                                    if (termItem.TermID == 8)//PreBoard2
                                    {
                                        if (testItem.TestType == "Theory")
                                        {
                                            ...
                                            theroyMaxMark = testItem.MaximumMarks;
                                            Pre2TheoryMinMark = testItem.MinimumMarks;
                                            theroyMinMark = testItem.MinimumMarks;
                                        ...
                                        if (testItem.TestType == "Practical")
                                        {
                                            ...
                                            practicalMaxMark = testItem.MaximumMarks;
                                            Pre2PracticalMinMark = testItem.MinimumMarks;
                                            practicalMinMark = testItem.MinimumMarks;
                            ...
                            subjectData.SubjectId = _context.Tbl_SubjectsSetup.Where(x => x.Subject_ID == item.SubjectId).Select(x => x.Subject_ID).FirstOrDefault();
                            subjectData.MarksUT1 = obtainedUT1Marks?.ObtainedMarks ?? -2;
                            subjectData.MaxMarksUT1 = UT1MaxMark;
                            subjectData.MinMarksUT1 = UT1MinMark;
                            ...
                            subjectData.MinMarksTerm1Practical = Term1PracticalMinMark;
                            subjectData.MinMarksTerm1Theory = Term1TheoryMinMark;
                            subjectData.MinMarksTerm2Practical = Term2PracticalMinMark;
                            subjectData.MinMarksTerm2Theory = Term2TheoryMinMark;
                            ...
                            subjectData.MinMarksSelectionPractical = SelectionPracticalMinMark;
                            subjectData.MaxMarksSelectionTheory = SelectionTheoryMaxMark;
                            subjectData.MinMarksSelectionTheory = SelectionTheoryMinMark;
                            ...
                            subjectData.MinMarksPromotionPractical = PromotionPracticalMinMark;
                            subjectData.MinMarksPromotionTheory = PromotionTheoryMinMark;
                            ...
                            subjectData.MinMarksPre1Practical = Pre1PracticalMinMark;
                            subjectData.MinMarksPre1Theory = Pre1TheoryMinMark;
                            ...
                            subjectData.MinMarksPre2Practical = Pre2PracticalMinMark;
                            subjectData.MinMarksPre2Theory = Pre2TheoryMinMark;
                    ...
                    TotalObtainedMarks = 0; subjectDatas.Add(subjectData);
                    allSubjects.Add(subjectData);

                    obtainedTheoryMarksT1 = null;
    ...
    ((NewobtainedPracticalMarksT1?.ObtainedMarks ?? -1) == -1 ? 0 : (NewobtainedPracticalMarksT1?.ObtainedMarks ?? -1));
      ...
      ((NewobtainedPracticalMarksT2?.ObtainedMarks ?? -1) == -1 ? 0 : (NewobtainedPracticalMarksT2?.ObtainedMarks ?? -1));
          ...
          ((NewobtainedPracticalMarksPromotion?.ObtainedMarks ?? -1) == -1 ? 0 : (NewobtainedPracticalMarksPromotion?.ObtainedMarks ?? -1));
                ...
                foreach (var item in subjectDatas)
                {
                    ...
                    if (termId != 10)
                    {
                        ...
                        SelectionPracticalTotal += (item.PracticalMarksSelection == -1 || item.PracticalMarksSelection == -2) ? 0 : item.PracticalMarksSelection;
                        SelectionTheoryMaxTotal += (item.MaxMarksSelectionTheory == -1 || item.MaxMarksSelectionTheory == -2) ? 0 : item.MaxMarksSelectionTheory;
                        SelectionPracticalMaxTotal += (item.MaxMarksSelectionPractical == -1 || item.MaxMarksSelectionPractical == -2) ? 0 : item.MaxMarksSelectionPractical;
                        SelectionAllTotal += (item.TotalObtainedMarksSelection == -1 || item.PracticalMarksSelection == -2) ? 0 : item.TotalObtainedMarksSelection;
                ...
                if (studentInfo.Class_Id == 414 || studentInfo.Class_Id == 415 || studentInfo.Class_Id == 416 || studentInfo.Class_Id == 417 || studentInfo.Class_Id == 614 || studentInfo.Class_Id == 615)
                {
                    CalculateOverallTotals(subjectDatas, totalResult, Convert.ToInt32(stdInfo.ClassID), termId, batchId);
                }
                ...
                TotalResultpercentage totalResultpercentage = new TotalResultpercentage()
                {
                    ...
                    T1Grade = GetGrade(PercentageCal(T1AllTotal, divisor01), Convert.ToInt32(stdInfo.ClassID), termId, batchId),
                    ...
                    OverallGrade = GetGrade(PercentageCal(OverallAllTotal, (UT1MaxTotal + UT2MaxTotal + Term1TheoryMaxTotal + Term1PracticalMaxTotal + Term2TheoryMaxTotal + Term2PracticalMaxTotal + Pre1TheoryMaxTotal + Pre1PracticalMaxTotal + Pre2TheoryMaxTotal + Pre2PracticalMaxTotal + SelectionPracticalMaxTotal + SelectionTheoryMaxTotal + PromotionPracticalMaxTotal + PromotionTheoryMaxTotal)), Convert.ToInt32(stdInfo.ClassID))
                ...
                if (studentInfo.Class_Id == 414 || studentInfo.Class_Id == 415 || studentInfo.Class_Id == 416 || studentInfo.Class_Id == 417 || studentInfo.Class_Id == 614 || studentInfo.Class_Id == 615)
                {
                    CalculateTotalResultPercentageValues(subjectDatas, totalResultpercentage, Convert.ToInt32(stdInfo.ClassID), termId, batchId);
                }
                ...
                if (termId != 10)
                {
                    ...
                    totalResult.SelectionTheoryTotal = SelectionTheoryTotal;
                    totalResult.SelectionPracticalTotal = SelectionPracticalTotal;
                    //totalResult.SelectionPracticalMaxTotal = SelectionPracticalMaxTotal;

                    totalResult.SelectionAllTotal = SelectionTheoryTotal + SelectionPracticalTotal;
                    SelectionAllTotal = totalResult.SelectionAllTotal;
                    totalResult.SelectionTheoryMaxTotal = SelectionTheoryMaxTotal;
                    totalResult.SelectionPracticalMaxTotal = SelectionPracticalMaxTotal;
                    totalResult.SelectionGrade = GetGradebyTermBatch(PercentageCal(SelectionAllTotal, divisor0Selection), Convert.ToInt32(stdInfo.ClassID), termId, batchId);
                ...
                foreach (var subjectData in subjectDatas)
                {
                    ...
                    if (subjectData.MarksUT1 == 0 && subjectData.MarksUT2 == 0 && subjectData.TotalMarks == 0 &&
                        ...
                        subjectData.TheoryMarksSelection == 0 && subjectData.PracticalMarksSelection == 0 && subjectData.TheoryMarksSelection == 0 && subjectData.TheoryMarksSelection == 0)
                    {
                ...
                var BoardId = _context.TblCreateSchool.Select(x => x.BoardID).FirstOrDefault();
                var classCoscholastic = _context.tbl_CoScholasticClass.Where(x => x.ClassID == stdInfo.ClassID && x.BoardID == BoardId).Select(x => x.CoscholasticID).ToList();
        ...
        {
            var seniorClassIds = new List<int> { 414, 415, 416, 417, 614, 615 };
            var protectedSubjectIds = new List<int> { 43, 44, 45, 54, 94 };

            // Separate subjects into protected and excludable
            var nonExcludableSubjects = subjectDatas
                .Where(s => protectedSubjectIds.Contains(s.SubjectId))
                .ToList();
            ...
            // Remove the lowest scoring excludable subject if class is XI/XII
            ...
            // Final list of subjects to include in calculations
            ...
            // TERM 2 Max totals (Obtained values are ignored for now, per original logic)
            decimal Term2TheoryMaxTotal = subjectsToInclude.Sum(s => s.MaxMarksTerm2Theory);
            decimal Term2PracticalMaxTotal = subjectsToInclude.Sum(s => s.MaxMarksTerm2Practical);
            ...
            // Helper: Alternate percentage calculator (if used elsewhere)
            decimal PercentageCal2(decimal obtained, decimal max) => max == 0 ? 0 : Math.Round((obtained / max) * 100, 1);
            ...
            // Final Overall % (based on T1 + UTs + Term2 max)
            totalResultpercentage.OverallAllTotal = PercentageCal2(OverallObtained, OverallMax);
        ...
        private void CalculateOverallTotals(List<SubjectData> subjectDatas, TotalResult totalResult, int classId, int termId, int batchId)
        {
            ...
            {
                var subjectToExclude = excludableSubjects
                        .OrderBy(s => Math.Max(0, s.TotalObtainedMarks)) // Exclude lowest total
                        .First();
                if (termId == 2)
                {
                    subjectToExclude = excludableSubjects
                       .OrderBy(s => Math.Max(0, s.TotalObtainedMarks)) // Exclude lowest total
                       .First();
                }
                else if (termId == 1)
                {
                    subjectToExclude = excludableSubjects
                        .OrderBy(s => Math.Max(0, s.MarksUT1)) // Exclude lowest total
                        .First();
                }
                else if (termId == 3)
                {
                    subjectToExclude = excludableSubjects
                        .OrderBy(s => Math.Max(0, s.MarksUT2)) // Exclude lowest total
                        .First();
                }
                else if (termId == 4)
                {
                    subjectToExclude = excludableSubjects
                        .OrderBy(s => Math.Max(0, s.TotalObtainedMarksUT2)) // Exclude lowest total
                        .First();
                }
                excludableSubjects.Remove(subjectToExclude);
            }
            ...
            // Helper function
            decimal SafeSum(Func<SubjectData, decimal> selector) =>
                subjectsToInclude.Sum(s => {
                    var val = selector(s);
                    return (val == -1 || val == -2) ? 0 : val;
                });

            // Set TotalResult fields using safe sums
            totalResult.UT1Total = SafeSum(s => s.MarksUT1);
            totalResult.UT2Total = SafeSum(s => s.MarksUT2);
            totalResult.UT1MaxTotal = SafeSum(s => s.MaxMarksUT1);
            totalResult.UT2MaxTotal = SafeSum(s => s.MaxMarksUT2);
            totalResult.UTAllTotal = SafeSum(s => s.TotalMarks);

            totalResult.TheoryTotalT1 = SafeSum(s => s.TheoryMarks);
            totalResult.PracticalTotalT1 = SafeSum(s => s.PracticalMarks);
            totalResult.T1AllTotal = SafeSum(s => s.TotalObtainedMarks);

            totalResult.TheoryTotalT2 = SafeSum(s => s.TheoryMarksUT2);
            totalResult.PracticalTotalT2 = SafeSum(s => s.PracticalMarksUT2);
            totalResult.T2AllTotal = SafeSum(s => s.TotalObtainedMarksUT2);

            totalResult.OverallAllTotal = SafeSum(s => s.TotalMarksBothUTs);

            totalResult.Term1TheoryMaxTotal = SafeSum(s => s.MaxMarksTerm1Theory);
            totalResult.Term1PracticalMaxTotal = SafeSum(s => s.MaxMarksTerm1Practical);
            totalResult.Term2TheoryMaxTotal = SafeSum(s => s.MaxMarksTerm2Theory);
            totalResult.Term2PracticalMaxTotal = SafeSum(s => s.MaxMarksTerm2Practical);

            var divisorT1 = totalResult.Term1TheoryMaxTotal + totalResult.Term1PracticalMaxTotal;
            var divisorT2 = totalResult.Term2TheoryMaxTotal + totalResult.Term2PracticalMaxTotal;

            // UT Grades
            totalResult.UT1TotalGrade = GetGradebyTermBatch(PercentageCal(totalResult.UT1Total, totalResult.UT1MaxTotal), classId, termId, batchId);
            totalResult.UT2TotalGrade = GetGradebyTermBatch(PercentageCal(totalResult.UT2Total, totalResult.UT2MaxTotal), classId, termId, batchId);

            // Term 1 Grade
            totalResult.T1Grade = GetGradebyTermBatch(
                PercentageCal(totalResult.T1AllTotal, divisorT1 == 0 ? 1 : divisorT1),
                classId, termId, batchId
            );

            // Term 2 Grade
            totalResult.T2Grade = GetGradebyTermBatch(
                PercentageCal(totalResult.T2AllTotal, divisorT2 == 0 ? 1 : divisorT2),
                classId, termId, batchId
            );

            // Overall Grade
            decimal overallMax = totalResult.UT1MaxTotal + totalResult.UT2MaxTotal
                + totalResult.Term1TheoryMaxTotal + totalResult.Term1PracticalMaxTotal
                + totalResult.Term2TheoryMaxTotal + totalResult.Term2PracticalMaxTotal;

            totalResult.OverallGrade = GetGradebyTermBatch(
                PercentageCal(totalResult.OverallAllTotal, overallMax == 0 ? 1 : overallMax),
                classId, termId, batchId
            );
        }
    ...
    ((NewobtainedPracticalMarksT1?.ObtainedMarks ?? -1) == -1 ? 0 : (NewobtainedPracticalMarksT1?.ObtainedMarks ?? -1));
      ...
      ((NewobtainedPracticalMarksT2?.ObtainedMarks ?? -1) == -1 ? 0 : (NewobtainedPracticalMarksT2?.ObtainedMarks ?? -1));
        ...
        public class SubjectData
        {
            ...
            public decimal MinMarksTerm1Practical { get; set; }
            public decimal MinMarksTerm1Theory { get; set; }
            ...
            public decimal MinMarksTerm2Practical { get; set; }
            public decimal MinMarksTerm2Theory { get; set; }
            ...
            public decimal MinMarksPre1Practical { get; set; }
            public decimal MinMarksPre1Theory { get; set; }
            public decimal MinMarksPre2Practical { get; set; }
            public decimal MinMarksPre2Theory { get; set; }
            ...
            public decimal MinMarksSelectionPractical { get; set; }
            public decimal MinMarksSelectionTheory { get; set; }
            ...
            public decimal MinMarksPromotionPractical { get; set; }
            public decimal MinMarksPromotionTheory { get; set; }
        ...
        public class TotalResult
        {
            ...
            public decimal SelectionTheoryTotal { get; internal set; }
            public decimal SelectionPracticalTotal { get; internal set; }
