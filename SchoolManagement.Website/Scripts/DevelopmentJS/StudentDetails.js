...
function GetAllStudentDetails() {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            html = html + '<thead id="stdnttblhead"><tr><th>Student ID</th><th>Name</th><th>Catogory</th><th>Class</th><th>Action</th></tr></thead>';
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                html += '<td>' + data[i].Semester + '</td>';
                html += '<td>';
                html += '<a href="/Student/FullStudentView?id=' + data[i].ScholarNumber + '" style="color:white;">View</a>&nbsp&nbsp;<a href="/Student/AddStudent?UpdateId=' + data[i].ScholarNumber + '"style="color:white;">Edit</a>&nbsp&nbsp;<a href="#" onclick="DeleleStudent(' + data[i].StudentId + ')"style="color:white;">Delete</a>';
                html += '</td>';
                html += '</tr>';
            }
