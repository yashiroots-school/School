        ...
        if (missingField !== "") {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    var th1 = $("<th>").text("Rank In Class").addClass("dynamic-header");
                    headerRow.append(th);
                    ...
                    $.each(result.data, function (index, student) {
                        ...
                        row.append($("<td>").css("display", "table-cell").append($("<span>").addClass("rank")));
                        serialNumber++;
                    ...
                    $("#TableBody tr").each(function () {
                        let row = $(this);
                        let studentId = row.find("td:eq(0)").attr("name");
                        let totalMarks = 0;

                        row.find("input[type='number']").each(function () {
                            let val = parseFloat($(this).val());
                            if (!isNaN(val)) totalMarks += val;
                        });
                    ...
                    studentsData.forEach((student, index) => {
                        ...
                        student.row.find("span.rank").text(currentRank);
            ...
            $.ajax({
                ...
                url: `/Exam/AllGrade2?classId=${classid}&TermId=${termid}&BatchId=${batchid}`,
    ...
    $('#SaveButton').click(function () {
        ...
        $("#TableStudent tbody tr").each(function () {
            let rowData = {
                ...
                RankInClass: parseInt($(this).find("span.rank").text()),
            ...
            $(this).find("td.TbHeade").each(function () {
                ...
                let SelectedRank = $(this).find("span.rank");
                console.log(SelectedRank.text())
